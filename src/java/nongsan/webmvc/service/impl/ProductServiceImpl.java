...
public class ProductServiceImpl implements ProductService {
	...
	public void edit(Product newProduct) {
		if (newProduct == null || newProduct.getId() == null || newProduct.getId().trim().isEmpty()) {
		...
		try {
			...
			if (oldProduct == null) {
				throw new IllegalArgumentException("Product not found with ID: " + newProduct.getId());
			}
			...
			throw new IllegalArgumentException("Invalid product ID format: " + newProduct.getId());
		}
	}
