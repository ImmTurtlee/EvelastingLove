...
<!--  content -->
  ...
  <section id="aa-catg-head-banner">
   <img src="${pageContext.request.contextPath}/view/client/assets/images/EvelastingLove1.png" height="70%" alt="banner sản phẩm">
                ...
                <c:forEach items="${productlist}" var="product">
	                ...
	                <li>
	                  <figure>
	                    ...
	                    <figcaption>
	                      <h5 class="aa-product-title"><a href="${pageContext.request.contextPath}/view/client/product-detail?id=${product.id}">${product.name}</a></h5>
