            ...
            <div class="row">
              <div class="col-md-4 col-sm-6">
                <div class="aa-footer-widget">
                  <a href="${pageContext.request.contextPath}/"><img src="${url}/images/logo_1-removebg.png" alt="logo img" width="200px"></a> 
              ...
              <div class="col-md-4 col-sm-6">
                <div class="aa-footer-widget">
                  <div class="aa-footer-widget">
                    <h3>LIÊN HỆ</h3>
                    <address>
                      <p>Khu Công Nghệ Cao Hòa Lạc, km 29, Đại lộ, Thăng Long, Hà Nội, Việt Nam</p>
                      <p><span class="fa fa-phone"></span>036.8131.655</p>
                      <p><span class="fa fa-envelope"></span>lumicare2025@gmail.com</p>
                    </address>
