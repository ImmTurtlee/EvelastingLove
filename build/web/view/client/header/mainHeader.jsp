...
<html lang="en">
  <head>
    ...
    <link href="${url}/css/bootstrap.css" rel="stylesheet">   
     <link rel="icon" href="${url}/images/496512124_1359701688480925_2044646328178335108_n.jpg" type="image/x-icon">
    ...
    <!-- Theme color -->
    <link id="switcher" href="${url}/css/theme-color/pink-theme.css" rel="stylesheet">
